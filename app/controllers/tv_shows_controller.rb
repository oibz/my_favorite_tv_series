class TvShowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tv_show.save
        format.html { redirect_to tv_show_url(@tv_show), notice: "La Serie se ha creado satisfactoriamente." }
  ...
  def update
    respond_to do |format|
      if @tv_show.update(tv_show_params)
        format.html { redirect_to tv_show_url(@tv_show), notice: "La Serie ha sido actualizada correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tv_shows_url, notice: "La Serie fue eliminada correctamente." }
